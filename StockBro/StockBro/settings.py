"""
Django settings for StockBro project.
...
SECRET_KEY = 'django-insecure-9yt$$c+fhc4!8^e=7q7jj0g&efteg)ixba-xtv9(iu10b!9amo'
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            # Configuring redis as channel layer
